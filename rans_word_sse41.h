...
#define _ -1 // for readability
        _mm_setr_epi8( _,_,_,_, _,_,_,_, _,_,_,_, _,_,_,_ ), // 0000
        _mm_setr_epi8( 0,1,_,_, _,_,_,_, _,_,_,_, _,_,_,_ ), // 0001
        _mm_setr_epi8( _,_,_,_, 0,1,_,_, _,_,_,_, _,_,_,_ ), // 0010
        _mm_setr_epi8( 0,1,_,_, 2,3,_,_, _,_,_,_, _,_,_,_ ), // 0011
        _mm_setr_epi8( _,_,_,_, _,_,_,_, 0,1,_,_, _,_,_,_ ), // 0100
        _mm_setr_epi8( 0,1,_,_, _,_,_,_, 2,3,_,_, _,_,_,_ ), // 0101
        _mm_setr_epi8( _,_,_,_, 0,1,_,_, 2,3,_,_, _,_,_,_ ), // 0110
        _mm_setr_epi8( 0,1,_,_, 2,3,_,_, 4,5,_,_, _,_,_,_ ), // 0111
        _mm_setr_epi8( _,_,_,_, _,_,_,_, _,_,_,_, 0,1,_,_ ), // 1000
        _mm_setr_epi8( 0,1,_,_, _,_,_,_, _,_,_,_, 2,3,_,_ ), // 1001
        _mm_setr_epi8( _,_,_,_, 0,1,_,_, _,_,_,_, 2,3,_,_ ), // 1010
        _mm_setr_epi8( 0,1,_,_, 2,3,_,_, _,_,_,_, 4,5,_,_ ), // 1011
        _mm_setr_epi8( _,_,_,_, _,_,_,_, 0,1,_,_, 2,3,_,_ ), // 1100
        _mm_setr_epi8( 0,1,_,_, _,_,_,_, 2,3,_,_, 4,5,_,_ ), // 1101
        _mm_setr_epi8( _,_,_,_, 0,1,_,_, 2,3,_,_, 4,5,_,_ ), // 1110
