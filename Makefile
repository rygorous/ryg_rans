...
OBJS := helper.o main_alias.o main_simd.o main.o main64.o main_nonchar.o main64_nonchar.o
DEPS := $(subst .o,.d,$(OBJS))
TARGET := main_alias.exe main_simd.exe main.exe main64.exe main_nonchar.exe main64_nonchar.exe 
